...
Route::get('/risk/{id?}',[RiskController::class,'index'])->name('risk.index');
Route::get('/risk/get/{id1?}/{id2?}/{id3?}/{id4?}/{id5?}/{id6?}/{id7?}',[RiskController::class,'get_risk'])->name('risk.get');
